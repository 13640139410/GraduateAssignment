...
/**
 * 查看全国个省市区 区域名称 区域编码 城市编码 区域划级
 */
public class TestGdmapDistrictActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_district);
    ...
    private void querySubDistrict(DistrictItem districtItem) {
        DistrictSearch districtSearch = new DistrictSearch(TestGdmapDistrictActivity.this);
        districtSearch.setOnDistrictSearchListener(TestGdmapDistrictActivity.this);
        // 异步查询行政区
        DistrictSearchQuery query = new DistrictSearchQuery();
