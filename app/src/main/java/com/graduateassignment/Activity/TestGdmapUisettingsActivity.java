...
public class TestGdmapUisettingsActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_uisettings);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonScale:
                ...
                ToastUtil.show(TestGdmapUisettingsActivity.this, "每像素代表" + scale + "米");
                break;
            /**
             * 设置地图默认的比例尺是否显示
             */
