 ...
 * 输入名称搜索指定地点
 */
public class TestGdmapDistrictboundActivity extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_districtbound);
    ...
    public void onDistrictSearched(DistrictResult districtResult) {
        if (districtResult == null || districtResult.getDistrict() == null) {
            //ToastUtil.show(TestGdmapDistrictboundActivity.this,"未知区域");
            return;
        }
        if(districtResult.getAMapException() != null && districtResult.getAMapException().getErrorCode() == AMapException.CODE_AMAP_SUCCESS)
        {
            ...
            if (districtResult.getAMapException() != null){
                ...
                ToastUtil.show(TestGdmapDistrictboundActivity.this,"没搜索到结果");
            }
        }
