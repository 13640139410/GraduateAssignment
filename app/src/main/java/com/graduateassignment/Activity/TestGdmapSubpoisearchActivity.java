...
import com.graduateassignment.Adapter.PoiListAdapter;
import com.graduateassignment.R;
import com.graduateassignment.Util.AMapUtil;
import com.graduateassignment.Util.ToastUtil;

public class TestGdmapSubpoisearchActivity extends Activity implements OnPoiSearchListener, TextWatcher, InputtipsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_subpoisearch);
    ...
    private void poi_Search(String str){
        ...
        PoiSearch poiSearch = new PoiSearch(TestGdmapSubpoisearchActivity.this,mPoiSearchQuery);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (!AMapUtil.IsEmptyOrNullString(newText)) {
            ...
            Inputtips inputTips = new Inputtips(TestGdmapSubpoisearchActivity.this, inputquery);
    ...
    public void onGetInputtips(List<Tip> tipList, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            ArrayAdapter<String> aAdapter = new ArrayAdapter<String>(
                    ...
                    R.layout.part_test_gdmap_subpoi_input, listString);
