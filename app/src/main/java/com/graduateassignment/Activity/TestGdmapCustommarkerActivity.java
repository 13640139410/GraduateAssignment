...
public class TestGdmapCustommarkerActivity extends BaseActivity implements OnMarkerClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_custommarker);
    ...
    public View getInfoContents(Marker marker) {
        ...
        View infoContent = getLayoutInflater().inflate(
                R.layout.part_test_gdmap_custommarker_infocontent, null);
    ...
    public View getInfoWindow(Marker marker) {
        ...
        View infoWindow = getLayoutInflater().inflate(
                R.layout.part_test_gdmap_custommarker_infowindow, null);
