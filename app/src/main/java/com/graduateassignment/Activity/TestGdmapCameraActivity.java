...
public class TestGdmapCameraActivity extends  Activity implements OnClickListener,
        CancelableCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_gdmap_camera);
	    /*
    ...
    public void onCancel() {
        ToastUtil.show(TestGdmapCameraActivity.this, "Animation to 陆家嘴 canceled");
    }
    ...
    public void onFinish() {
        ToastUtil.show(TestGdmapCameraActivity.this, "Animation to 陆家嘴 complete");
    }
}
